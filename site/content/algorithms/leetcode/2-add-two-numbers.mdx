export const title = "Linked List - LeetCode 2. Add Two Numbers";
export const description = "LeetCode problem";
export const createdAt = "2025-03-17";
export const path = "algorithms/leetcode/2-add-two-numbers";
export const tags = ["linked-list, two-pointer"];
