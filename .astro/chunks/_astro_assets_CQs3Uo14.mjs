...
import { D as DEFAULT_OUTPUT_FORMAT, V as VALID_SUPPORTED_FORMATS, a as DEFAULT_HASH_PROPS } from './root-layout_dHOepDvz.mjs';
...
const baseService = {
  ...
  getURL(options, imageConfig) {
    ...
    const imageEndpoint = joinPaths("/dist/dev/build-algo", imageConfig.endpoint.route);
